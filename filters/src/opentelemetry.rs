...
mod tests {
    ...
    fn projects_only_validated_routing_attributes() {
        ...
        assert_eq!(fields.provider, "model-a");
        assert_eq!(fields.cluster, "provider-a");
        assert_eq!(fields.site, "site-a");
        assert_eq!(fields.stable_id, "stable-a");
        assert_eq!(fields.local_site, "site-local");
        assert_eq!(fields.rank, Some(2));
        assert_eq!(fields.tier, Some("same_region"));
