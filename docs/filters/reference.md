...
| Filter | Description |
|--------|-------------|
| [`grid_credential_inject`](grid_credential_inject.md) | Replaces caller credentials with the upstream credential selected by `grid_route` or `grid_provider_route`. |
